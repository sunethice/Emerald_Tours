...
//Excursions
export const LIST_EXCURSIONS = "LIST_EXCURSIONS";
export const LIST_EXCURSION_IDS = "LIST_EXCURSION_IDS";
export const LIST_EXCURSIONS_FAILURE = "LIST_EXCURSIONS_FAILURE";
export const ADD_EXCURSION = "ADD_EXCURSION";
export const ADD_EXCURSION_FAILURE = "ADD_EXCURSION_FAILURE";
export const EDIT_EXCURSION = "EDIT_EXCURSION";
export const EDIT_EXCURSION_FAILURE = "EDIT_EXCURSION_FAILURE";
