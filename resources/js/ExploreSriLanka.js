...
import { rgb2hex } from "./utils/commonfunc";
import lg from "./img/logo1.png";
import { useState, useEffect, useRef } from "react";
import "./css/ExploreSriLanka.css";
import "./css/App.css";
...
function ExploreSriLanka() {
    ...
    function getComponent(e) {
        if (district_state.prevDistrictID !== "") {
            $("path[id = " + district_state.prevDistrictID + "]").css({
                fill: district_state.districtColor
            });
        }
        setDistrict({
            districtColor: rgb2hex(
                $("path[id = " + e.target.id + "]").css("fill")
            ),
            prevDistrictID: e.target.id
        });
        $("path[id = " + e.target.id + "]").css({
            fill: "#ff0000"
        });
        // @refs.trigger.hide();
    }

    function popoverRight(districtID, districtName) {
        const popoverEl = useRef();
        return (
            <Popover ref={popoverEl} id={"PO-" + districtID}>
                <Popover.Title as="h3">{districtName}</Popover.Title>
                <Popover.Content>
                        ...
                        <div className="col-12 mapCol">
                            ...
                            >
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2449", "Mātale")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2451", "Ampāra")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2458", "Mulativ")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2464", "Gālla")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2466", "Mātara")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2467", "Badulla")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2469", "Kægalla")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2470", "Kŏḷamba")}
                                >
                                    <path
                                ...
                                <OverlayTrigger
                                    ...
                                    rootClose
                                    onHide={onClose()}
                                    overlay={popoverRight("LKA2471", "Gampaha")}
                                >
                                    <path
